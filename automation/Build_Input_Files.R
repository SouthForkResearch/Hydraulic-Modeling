...
Operator = "AWS Automation"

# Call this script like this:
# Rscript /Users/work/Projects/CHaMP/Hydraulic-Modeling/automation/Build_Input_Files.R /Users/work/Projects/CHaMP/Hydraulic-Modeling/ /Users/work/Desktop/VISIT_3464/ /Users/work/Desktop/VISIT_3464/Hydro/Results/CFD_Site_List.csv

savedwd = getwd()

# Lookup arguments from the command line
...
for (k in 1:nrow(site.list)){
  if (site.list$Model[k] == "Yes") {
    ...
    if (site.list$Measured.Discharge[k] == site.list$Modeled.Discharge[k]){
      site.list$D3D.Input.Folder[k]=paste(site.list$Directory[k],"S", Variant.str, sep="")} 
    else{
...
for (k in 1:nrow(site.list)){
  dir.create(site.list$Results.Folder)
}
